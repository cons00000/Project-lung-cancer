...
class ToolBox(DataSet):
    ...
    def get_dataset_description(self, parameter_list: list =['Modality', 'SliceThickness','PixelSpacing', 'SeriesDate', 'Manufacturer']) -> DataFrame:
    ...
    def __get_roi(self,region_of_interest,rt_path):
        ...
        rt_structure = pydicom.dcmread(rt_path,force=True)
        roi_list = []
